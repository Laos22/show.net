...
if ( ! class_exists( 'Scllgn_Settings_Tabs' ) ) {
	class Scllgn_Settings_Tabs extends Bws_Settings_Tabs {
		...
		public function tab_settings() {
			...
			<table class="form-table scllgn_google_client_data">
				<tr>
					...
					<td>
						...
						<div class="bws_info">
							<?php _e( 'You need to create your own credentials in order to use google API.', 'social-login-bws' ); ?> <a href="https://bestwebsoft.com/documentation/social-login/social-login-user-guide/#h.c6m4s1fydbx8" target="_blank" nohref="nohref"><?php _e( 'Learn More', 'social-login-bws' ); ?></a>
						</div>
					</td>
				</tr>
				<tr>
			...
			<table class="form-table scllgn-form-table scllgn_facebook_client_data">
				<tr>
					...
					<td>
						...
						<div class="bws_info">
							<?php _e( 'You need to create your own credentials in order to use Facebook API.', 'social-login-bws' ); ?> <a href="https://bestwebsoft.com/documentation/social-login/social-login-user-guide/#h.t838pgiu644m" target="_blank" nohref="nohref"><?php _e( 'Learn More', 'social-login-bws' ); ?></a>
						</div>
					</td>
				</tr>
				<tr>
			...
			<table class="form-table scllgn-form-table scllgn_twitter_client_data">
				<tr>
					...
					<td>
						...
						<div class="bws_info">
							<?php _e( 'You need to create your own credentials in order to use twitter API.', 'social-login-bws' ); ?> <a href="https://bestwebsoft.com/documentation/social-login/social-login-user-guide/#h.1yecq5cyrs0u" target="_blank" nohref="nohref"><?php _e( 'Learn More', 'social-login-bws' ); ?></a>
						</div>
					</td>
				</tr>
				<tr>
			...
			<table class="form-table scllgn-form-table scllgn_linkedin_client_data">
				<tr>
					...
					<td>
						...
						<div class="bws_info">
							<?php _e( 'You need to create your own credentials in order to use linkedin API.', 'social-login-bws' ); ?> <a href="https://bestwebsoft.com/documentation/social-login/social-login-user-guide/#h.kc920jaw22v2" target="_blank" nohref="nohref"><?php _e( 'Learn More', 'social-login-bws' ); ?></a>
						</div>
					</td>
				</tr>
				<tr>
			...
			<?php /*INSTAGRAM*/ ?>
			<div class="bws_tab_sub_label scllgn_instagram_client_data">Instagram</div>
			<table class="form-table scllgn-form-table scllgn_instagram_client_data">
				<tr>
					<th><?php _e( 'Client ID', 'social-login-bws' ); ?></th>
					<td>
						<input type="text" name="scllgn_instagram_client_id" value="<?php echo $this->options['instagram_client_id']; ?>" size="20" />
						<div class="bws_info">
							<?php _e( 'You need to create your own credentials in order to use instagram API.', 'social-login-bws' ); ?> <a href="https://bestwebsoft.com/documentation/social-login/social-login-user-guide/" target="_blank" nohref="nohref"><?php _e( 'Learn More', 'social-login-bws' ); ?></a>
						</div>
					</td>
				</tr>
				<tr>
					<th><?php _e( 'Client Secret', 'social-login-bws' ); ?></th>
					<td>
						<input type="text" name="scllgn_instagram_client_secret" value="<?php echo $this->options['instagram_client_secret']; ?>" size="20">
					</td>
				</tr>
				<tr>
					<th><?php _e( 'Button Display', 'social-login-bws' ); ?></th>
					<td>
						<fieldset>
							<label>
								<input type="radio" name="scllgn_instagram_display_button" value="long" <?php checked( 'long' == $this->options['button_display_instagram'] ); ?> />
							</label>
							<div class="scllgn_login_button scllgn_login_button_long scllgn_instagram_button" id="scllgn_instagram_button">
								<span class="dashicons bws-icons dashicons-instagram scllgn_instagram_button_admin"></span>
								<span class="scllgn_button_text" ><input type="text" name="scllgn_instagram_button_text" value="<?php echo $this->options['instagram_button_name']; ?>" /></span>
							</div>
							<span class="dashicons dashicons-welcome-write-blog"></span>
							</div>
							<br/>
							<label>
								<input type="radio" name="scllgn_instagram_display_button" value="short" <?php checked( 'short' == $this->options['button_display_instagram'] ); ?> />
							</label>
							<div class="scllgn_login_button scllgn_instagram_button scllgn_login_button_short scllgn_login_button_icon">
								<span class="scllgn_span_icon dashicons bws-icons scllgn_instagram_button_admin "></span>
							</div>
						</fieldset>
					</td>
				</tr>
